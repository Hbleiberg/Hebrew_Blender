...
def main():
    ...
    ap.add_argument('--upstream', required=True, help='URL of the exact upstream file (provenance)')
    ...
    print('\nStaged starting-fonts/%s/ and updated the manifest. No sw.js bump needed for intake.' % slug)
