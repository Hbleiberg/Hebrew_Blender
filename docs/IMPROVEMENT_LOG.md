...
- [ ] P2 (**NEW S380 Pass H — FIRST PICK for S381: found after the Font Maker's two governor slots were spent; probes `h380/stack.mjs`, screens `fix2-off-*.png`**) | Hebrew_Font_Maker.html | **An `askModal` raised while a later-DOM overlay is open paints BENEATH it: every `.overlay` is `z-index:200` and `#askOverlay` (DOM 1748) precedes `#myFontsOverlay` (1767), `#helpOverlay`, `#qaOverlay`, …[full text: IMPROVEMENT_ARCHIVE.md]
...
- 2026-09-11 | **S379** | iters: 1 pass (**I**) + 4 fixes = **5** (full budget) | tools: index + generator + flash + dashboard (`4f9a2e7`), generator + dictionary + torah + trope (`f4a102d`), Hebrew_Font_Maker (`0346a0b`), classroom_dashboard (`de49066`) | patterns fixed: …[full text: …[full text: IMPROVEMENT_ARCHIVE.md]
...
- **S380 (2026-09-11):** hebrew_dictionary 2026-09-11 (`f4a102d`; D S378); classroom_dashboard 2026-09-11 (`de49066`; G S364); torah_trainer 2026-09-11 (`f4a102d`); trope_tutor 2026-09-11 (`f4a102d`; M S376); flash_cards 2026-09-11 (`4f9a2e7`; N S361); Hebrew_Font_Maker **2026-09-11 (`e71ec09`; H S380)**; resources 2026-09-11 (`b1c0655`; N S375); privacy 2026-09-11 (`f8f23e0`; S360); hebrew_blend_generator 2026-09-11 (`f4a102d`; H S363); index 2026-09-11 (`4f9a2e7`; S379); contact / terms / 404 2026-09-09 (S359–S361 chrome).
