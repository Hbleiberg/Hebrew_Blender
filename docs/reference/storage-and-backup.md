...
| `tropeTutorSettings` | `hebrewTropeTutor_settings` | Trope Tutor settings (tradition, melody, font, drill toggles, playback rate); object blob merged via `ivritSafeAssign`, empty = never-set (skipped on import) |
