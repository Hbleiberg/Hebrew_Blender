...
- **Pages that offer accounts** (Home, Generator, Flash Cards, Dictionary, Torah Trainer, Trope Tutor, Dashboard, Font Maker, `account-test.html`, `saves-test.html`): `cdn.jsdelivr.net` in `script-src` (the
