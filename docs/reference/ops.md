...
- **Pages that offer accounts** (`account-test.html`, `saves-test.html`, Trope Tutor, Torah Trainer, Flash Cards, Generator, Dictionary): `cdn.jsdelivr.net` in `script-src` (the
