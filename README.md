...
| `data/trope/trope_phrases.json` | Every row of both printed charts as data — notes, syllables, triplets, ties and slurs — plus each mark's figures by context; drawn by the Trope Tutor's Phrases tab, and the base for a future staff of a whole reading |
